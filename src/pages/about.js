  ...
  return (
    <Fragment>
      <Layout>
        ...
        <div>
          <ContentWrapper>
            <h1 style={{ margin: "0 auto", width: "80vh" }}>About</h1>
            <p>
              <img
                css={{
                  display: "block",
              ...
              HTML 3.2 frames site build exclusively in MS Notepad, a horrendous
            ...
            <p>
              In this field, I developed a desire to learn, fostering a passion
              for creativity in design.
            </p>
            <h3>Ministry</h3>
            <p>
              I never imagined that one day I will enter into pastoral ministry,
              but I have, and for the last decade I have served in several
              Methodist Churches as a pastor. I am currently a seminary student
              at{" "}
            ...
            <p>
              ...
              this has been an <em>eclectic</em> life. This is just my story. If
              you take time to look at yours, I am sure you will see a journey
              which is diverse and unique.
            </p>
          </ContentWrapper>
        </div>
      </Layout>
